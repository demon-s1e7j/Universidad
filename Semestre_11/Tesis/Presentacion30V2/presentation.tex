...
\newcommand{\drawparal}[7]{ % pos_x, pos_y, v_x, v_y, v_z, label, id
  ...
  \begin{frame}[allowframebreaks]
    ...
    \begin{frame}[allowframebreaks]
      \frametitle{Un error es, esencialmente, una operación que no controlan}
      Un error es:
      \begin{align}
        \begin{split}
    ...
    \begin{frame}[allowframebreaks]
      \frametitle{Repetition Code: Se puede proyectar un solo qubit fisico en un qubit logico repetido}
      \centering
    ...
    \begin{frame}[allowframebreaks]
      \frametitle{Repetition Code: Los errores a los que corrige el repetition code son bitflips en un solo qubit}
      ...
      \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
          Este conjunto de operadores representa el canal de ruido donde, como máximo, ocurre un error de bit-flip.
        \end{column}
      \end{columns}
    \end{frame}

    \begin{frame}[allowframebreaks]
      \frametitle{El codigo de repeticion corrige estos errores pues}
      \begin{itemize}
        \item $i = j$
          \begin{align*}
            PE^\dagger_iE_jP &= \alpha_{ij}P\\
        ...
        \item $i \neq j$
          ...
          Al aplicar el error al proyecto dan siempre estados ortogonales y por tanto el resultado es 0.
